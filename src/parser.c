...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_help_line] = STATE(25),
    [sym_type_line] = STATE(25),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [36] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_help_line, 4, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_metric_type, 1, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_line, 4, 0, 0),
